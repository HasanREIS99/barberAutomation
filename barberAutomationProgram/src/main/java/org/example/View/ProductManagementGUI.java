...
// Ürün tablosundaki stok değerini güncelle
    ...
    public class ButtonEditor extends DefaultCellEditor {
        ...
        public ButtonEditor() {
            ...
            btn_plus.setIcon(new ImageIcon(new ImageIcon(getClass().getResource("/images/plus.png")).getImage()));

            btn_edit = new JButton();
            btn_edit.setIcon(new ImageIcon(new ImageIcon(getClass().getResource("/images/edit.png")).getImage()));

            btn_delete = new JButton();
            btn_delete.setIcon(new ImageIcon(new ImageIcon(getClass().getResource("/images/delete.png")).getImage()));
...
//}
    ...
    public class ButtonRenderer extends JPanel implements TableCellRenderer {
        ...
        Image img_plus = new ImageIcon(this.getClass().getResource("/images/plus.png")).getImage();
        Image img_delete = new ImageIcon(this.getClass().getResource("/images/delete.png")).getImage();
        Image img_edit = new ImageIcon(this.getClass().getResource("/images/edit.png")).getImage();
